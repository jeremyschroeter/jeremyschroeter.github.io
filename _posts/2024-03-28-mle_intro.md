...
$$
## A Final Example
As a final example lets find the maximum likelihood estimate for the Poisson distribution which has parameter $\lambda$. The Poisson distribution expresses the probability of a given number of events happening in a fixed interval of time or space, and is given by
$$
...
\end{aligned}
$$
Thus, the maximum likelihood estimator for the Poisson distribution is the simply the sample mean.
<br><br>
### Appendix
